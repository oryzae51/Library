...
cnt_dir <- "/Users/hmkim/data/042722_Klf2_Ring1b/quant/cnt/"
results_dir <- "/Users/hmkim/Library/Mobile Documents/com~apple~CloudDocs/ETL/Cowork/Klf2-Ring1b paper/results/"
setwd("/Users/hmkim/data/042722_Klf2_Ring1b/quant/cnt")

##Automate count data.frame 
#Load data directory
src_dir <- c()
src_dir <- c("/Users/hmkim/data/042722_Klf2_Ring1b/quant/cnt")
...
names(cnts) <- c("Klf2KO_1", "Klf2KO_2", "Klf2KORing1bKD_1", "Klf2KORing1bKD_2", "Ring1bKD_1", "Ring1bKD_2", "wt_1", "wt_2") #change col name

#make condition table for downstream processing
condition <- c("Klf2KO", "Klf2KO", "Klf2KORing1bKD", "Klf2KORing1bKD", "Ring1bKD", "Ring1bKD", "wt", "wt")
sampleName <- c("Klf2KO_1", "Klf2KO_2", "Klf2KORing1bKD_1", "Klf2KORing1bKD_2", "Ring1bKD_1", "Ring1bKD_2", "wt_1", "wt_2")
...
####################################################################################
##Draw MA plots
res <- results(dds, contrast = c("condition", "Ring1bKD", "wt"), alpha = 0.05)
resultsNames(dds)
resLFC <- lfcShrink(dds, coef="condition_Ring1bKD_vs_wt", type="apeglm", res=res)
...
ensembl_id <- substr(ensembl_id, 1, 18)
res_genesym <- getBM(attributes = c("ensembl_gene_id", "mgi_symbol"),
...
names(notassigned_df) <- c("ensembl_gene_id", "mgi_symbol")
...
resLFC$gene_sym <- res_genesym$mgi_symbol
...
write.csv(as.data.frame(resLFC), 
          file = paste(results_dir, "resLFC.csv", sep = ""))
