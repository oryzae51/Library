...
setwd("/Users/hmkim/data/110921_PolII_Hoa/quant_data/cnt")

##Automate count data.frame 
#Load data directory
src_dir <- c()
src_dir <- c("/Users/hmkim/data/110921_PolII_Hoa/quant_data/cnt")
...
resultsNames(dds)
resLFC <- lfcShrink(dds, coef="condition_polKO_vs_wt", type="apeglm", res=res)
