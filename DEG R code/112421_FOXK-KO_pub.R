...
condition <- c("WT", "WT", "FOXK1KO", "FOXK1KO")
sampleName <- c("WT_1", "WT_2", "FOXK1KO_1", "FOXK1KO_2")
...
####################################################################################
##Draw MA plots
res <- results(dds, contrast = c("condition", "FOXK1KO", "WT"), alpha = 0.05)
resultsNames(dds)
resLFC <- lfcShrink(dds, coef="condition_FOXK1KO_vs_WT", type="apeglm", res=res)
...
##Save deg_data
#Raw deg
setwd("/Users/hmkim/data/112421_FOXK1-KO_pub")
