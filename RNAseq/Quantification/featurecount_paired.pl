...
foreach (@sam_list){
    ...
    `/media/bm/790240e4-2887-451f-ad02-1b19c4b4e120/Tools/subread-2.0.1-Linux-x86_64/bin/featureCounts -T 8 -p -M -s $strandedness -a $gtf_dir -o $out_dir/$Oname_1[-1].txt $_`;
}
