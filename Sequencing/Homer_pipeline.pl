...
chomp($p_directory);
my $specific_name = "*.duprm.bam"; #specific_name for dup removed bam file
...
for (my $i=0; $i<$#file_list+1; $i+=1){
    ...
    #print("$file_list[$i]\n");
    `/media/bm/790240e4-2887-451f-ad02-1b19c4b4e120/Tools/HOMER/bin/makeTagDirectory \
$p_directory/Tagdir_dir/$Oname_2[0] \
$p_directory/aligned/$file_list[$i]` ;
    print("Making bed file with Homer findPeaks, options -style factor, histone");
    `/media/bm/790240e4-2887-451f-ad02-1b19c4b4e120/Tools/HOMER/bin/findPeaks \
$p_directory/Tagdir_dir/$Oname_2[0] \
-style factor -o auto `;
    `/media/bm/790240e4-2887-451f-ad02-1b19c4b4e120/Tools/HOMER/bin/findPeaks \
$p_directory/Tagdir_dir/$Oname_2[0] \
-style histone -o auto `; 
}
